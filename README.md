...
1. 最新のリリースから`EffekseerForYMM4.ymme`をダウンロードします。
2. ダウンロードしたファイルをYukkuriMovieMaker4にドラッグ＆ドロップしてインストールします。
3. 映像エフェクトに「Effekseerビデオエフェクト」が追加されます。
4. 音声エフェクトに「Effekseer音声エフェクト」が追加されます。
5. エフェクトファイル（.efkefc, .efk）を選択して再生します。
