...
public:
  ...
  void SetSoundCallbacks(EffekseerForNative::LoadSoundFunc loadSound,
  ...
  void SetProjectionPerspective(float fov, int width, int height,
                                float nearValue, float farValue);
  void SetProjectionOrthographic(float width, float height, float nearValue,
                                 float farValue);
  void SetCameraLookAt(float positionX, float positionY, float positionZ,
