...
namespace EffekseerForNative
{
    ...
    using PlaySoundFunc = void(EFK_STDCALL*)(
        int32_t id,
        float volume,
        float pan,
        float pitch,
    ...
    {
    public:
        explicit CustomSoundData(int32_t id)
            : SoundId(id)
        {
        }
    ...
    public:
        ...
        void Pause(::Effekseer::SoundHandle handle, ::Effekseer::SoundTag tag, bool pause) override;
