...
namespace EffekseerForNative
{
    CustomSoundLoader::CustomSoundLoader(
        ...
        : loadSound_(loadSound)
        , unloadSound_(unloadSound)
    {
    }
    ...
    ::Effekseer::SoundDataRef CustomSoundLoader::Load(const char16_t* path)
    {
        ...
        return id < 0
            ? nullptr
            : ::Effekseer::MakeRefPtr<CustomSoundData>(id);
    }
    ...
    ::Effekseer::SoundHandle CustomSoundPlayer::Play(
        ::Effekseer::SoundTag,
    ...
    void CustomSoundPlayer::Pause(::Effekseer::SoundHandle, ::Effekseer::SoundTag, bool)
    {
    }

    bool CustomSoundPlayer::CheckPlaying(::Effekseer::SoundHandle, ::Effekseer::SoundTag)
    {
        return false;
    }
    ...
    bool CustomSoundPlayer::CheckPlayingTag(::Effekseer::SoundTag)
    {
        return false;
    }
